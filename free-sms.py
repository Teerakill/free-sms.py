...
def logo():
    if sys.platform.startswith("linux"):
        ...
        os.system('color ' +random.choice(['f'])+ " & cls & title FREESMS BY : Node.js")
        
print('''
             _____ ____  _____ _____ ____  __  __  ____
            |  ___|  _ \| ____| ____/ ___||  \/  |/ ___|
            | |_  | |_) |  _| |  _| \___ \| |\/| |\___  
            |  _| |  _ <| |___| |___ ___) | |  | | __ ) |
            |_|   |_| \_\_____|_____|____/|_|  |_||____/
